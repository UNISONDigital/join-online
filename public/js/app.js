...
UNISON.StepThree = {
  ...
  setupEmployerSelectize: function setupEmployerSelectize() {
...
UNISON.StepTwo = {
  ...
  setupAddressAutocomplete: function setupAddressAutocomplete() {
    this.autoCompleteController = new IdealPostcodes.Autocomplete.Controller({
      ...
      onAddressSelected: function onAddressSelected() {
        UNISON.StepTwo.onAddressSelected();
      },
      onInput: function onInput() {
        UNISON.StepTwo.onAddressInput();
      },
      onSuggestionsRetrieved: function onSuggestionsRetrieved() {
  ...
  onShowLookup: function onShowLookup(e) {
    e.preventDefault();
  ...
  onAddressSuggestionsRetrieved: function onAddressSuggestionsRetrieved() {
    this.hideLoader();
  },

  onAddressSuggestionsClosed: function onAddressSuggestionsClosed() {
    this.hideLoader();
  },
  ...
  hideAddressToggleButton: function hideAddressToggleButton() {
    this.SELECTOR.find('.js-address-toggle').addClass('step__form-toggle--hidden');
  },

  showAddressToggleButton: function showAddressToggleButton() {
    var autoForm = this.SELECTOR.find('.js-address-auto');
    autoForm.removeClass('js-address-auto--hidden');
  },
  ...
  createListeners: function createListeners() {
    ...
    this.SELECTOR.find('.js-show-lookup').on('click', function (e) {
      UNISON.StepTwo.onShowLookup(e);
    });
  }
};
...
!function (a, b) {
  ...
  }, r.isArray = Array.isArray, r.parseJSON = JSON.parse, r.nodeName = B, "function" == "function" && __webpack_require__(13) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
    return r;
  }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
...
UNISON.informationBlock = {
  ...
  init: function init() {
    _this.SELECTOR = $('.information-block');
    UNISON.informationBlock.createListeners();
  },

  onBlockClicked: function onBlockClicked(e) {
    var el = $(e.currentTarget).find('.information-block__items');
    el.toggleClass('information-block__items--active');
  },

  createListeners: function createListeners() {
    _this.SELECTOR.on('click', function (e) {
      UNISON.informationBlock.onBlockClicked(e);
    });
  }
